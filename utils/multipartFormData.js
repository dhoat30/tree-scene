export const multipartFormData = [
  ...
  },
  {
    ...
    options: [
      {
        value: "Tree Removal",
        label: "Tree Removal - Starting from $299",
        price: 0,
      },
      {
        value: "Tree Pruning",
        label: "Tree Pruning - Starting from $299",
        price: 0,
      },
      {
        value: "Hedge Trimming",
        label: "Hedge Trimming - Starting from $149",
        price: 0,
      },
      {
        value: "Land Clearing",
        label: "Land Clearing - Starting from $499",
        price: 0,
      },
      {
        value: "Storm-Damaged and Emergency Tree Work",
        label: "Storm-Damaged and Emergency Tree Work",
        price: 0,
      },
      {
        value: "Chipping and Wood Splitting Services",
        label: "Chipping and Wood Splitting Services",
        price: 0,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "Medium (6ft - 26ft / 2m-4m)",
        label: "Medium (6ft - 26ft / 2m-8m)",
      },
      {
        value: "Large (more than 26ft / 8m)",
        label: "Large (more than 13ft / 8m)",
      },
