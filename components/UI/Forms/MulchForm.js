...
import { mulchFormData } from "@/utils/mulchFormData";
...
export default function MulchForm({ className, formName = "Get a Quote Form", title = "Please fill out a form" }) {
    ...
    const submitHandler = (e) => {
        ...
        const dataPayload = {
            ...
            portalID: "46904146",
            hubspotFormID: "78263dcb-41dd-432d-a228-1cf14f640a67",
            hubspotFormObject: [
    ...
    const formInputs = mulchFormData.map((field, index) => {
        if (field.id === 'service') {
